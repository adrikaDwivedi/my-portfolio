...
const ACTIVITIES: Activity[] = [
  { status: "CREATED", repo: "adrikaDwivedi/Gulpy",           title: "new branch: feat/streak-system — water intake tracker",             date: "May 25, 2026" },
  { status: "PUSHED",  repo: "adrikaDwivedi/tasker-web-app",  title: "feat: add task filtering and priority sorting",                      date: "May 19, 2026" },
  { status: "CREATED", repo: "adrikaDwivedi/trackemApp",      title: "new branch: ui/dashboard-redesign",                                 date: "May 12, 2026" },
  { status: "PUSHED",  repo: "adrikaDwivedi/AiChatBot",       title: "fix: handle empty API response gracefully",                         date: "Apr 30, 2026" },
  { status: "PUSHED",  repo: "adrikaDwivedi/Coursified",      title: "feat: add course progress tracking and completion badges",           date: "Apr 18, 2026" },
  { status: "PUSHED",  repo: "adrikaDwivedi/si-backend-server","title": "chore: refactor auth middleware and add rate limiting",           date: "Mar 22, 2026" },
];
      ...
      <div className="max-w-6xl mx-auto pl-8 md:pl-16 pr-8 md:pr-16 py-24">
        ...
        >
          {STATS.map(({ value, label }, idx) => (
            ...
            >
              <p className="text-3xl font-black text-gray-950 dark:text-white leading-none mb-1">{value}</p>
