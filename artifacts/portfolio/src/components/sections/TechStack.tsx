      ...
      <div className="max-w-6xl mx-auto pl-8 md:pl-16 pr-8 md:pr-16 py-24">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-950 dark:text-white mb-4 leading-tight">
              Tech Stack
            </h2>
            <p className="font-mono text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-10 max-w-sm">
          ...
          <motion.div
            ...
            className="bg-gray-950 dark:bg-gray-900 border border-transparent dark:border-gray-800 text-white p-8 flex flex-col gap-6"
          >
            ...
            <div className="bg-black dark:bg-gray-950 border border-gray-800 p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  onClick={() => navigator.clipboard.writeText("adrikad97@gmail.com")}
              ...
              <p className="font-mono text-sm text-gray-300">
                <span className="text-gray-500">$</span> adrikad97@gmail.com
              </p>
            </div>
